...
<div class="max-w-4xl mx-auto space-y-6 pb-20 px-2 sm:px-4">
    ...
    <div>
        <x-breadcrumbs :items="[
            ...
            ['label' => 'Edit Coupon: ' . $coupon->code]
        ]" />
        <div class="flex items-center justify-between mt-2">
            <div>
                <h1 class="text-2xl font-black tracking-tight text-slate-900 dark:text-white">
                    Edit Coupon <span class="text-emerald-600 font-mono">#{{ $coupon->code }}</span>
                </h1>
                <p class="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                    Update discount rates, usage limitations, or validity schedule with datepicker.
                </p>
            </div>
    ...
    >
        <form method="POST" action="{{ route('admin.coupons.update', $coupon->id) }}" class="space-y-6" id="couponEditForm">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        >
                        <p class="text-[11px] text-slate-400 mt-1">Internal title or promotional banner headline.</p>
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input 
                                ...
                                min="0.01" 
                                name="discount_value" 
                                value="{{ old('discount_value', (float)$coupon->discount_value) }}" 
                                required 
                    ...
                    <div x-show="discountType === 'percentage'" x-transition>
                        ...
                        <div class="relative">
                            <input 
                                ...
                                value="{{ old('maximum_discount', $coupon->maximum_discount ? (float)$coupon->maximum_discount : '') }}" 
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-1">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input 
                                ...
                                value="{{ old('minimum_order_amount', $coupon->minimum_order_amount ? (float)$coupon->minimum_order_amount : '') }}" 
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            class="w-full px-3.5 py-2.5 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl text-xs text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition"
                        >
                        <p class="text-[11px] text-slate-400 mt-1">Current used: <strong>{{ $coupon->used_count }}</strong> times.</p>
                    </div>
            ...
            <div class="space-y-4 pt-2">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-[11px] text-slate-400">Leave blank to activate immediately.</p>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative flex items-center">
                            ...
                            <input 
                                ...
                                id="expires_at"
                                name="expires_at" 
                                value="{{ old('expires_at', $coupon->expires_at ? $coupon->expires_at->format('Y-m-d H:i') : '') }}" 
                ...
                <div class="pt-2">
                    <label class="inline-flex items-center gap-3 cursor-pointer p-3.5 rounded-2xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 select-none hover:border-emerald-300 dark:hover:border-emerald-800 transition">
                        <input type="checkbox" name="is_active" value="1" {{ old('is_active', $coupon->is_active) ? 'checked' : '' }} class="h-4 w-4 rounded border-slate-300 text-emerald-600 focus:ring-emerald-500">
                        <div>
                            <div class="text-xs font-bold text-slate-900 dark:text-white">Active Status</div>
                            <div class="text-[11px] text-slate-400">Coupon is active and available for customer use.</div>
                        </div>
                    </label>
                </div>
            </div>
