...
const contactUsPageCode = `"use client";
...
export default function ContactUsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 text-white pt-14 pb-24 px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-4xl mx-auto text-center space-y-4">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-300 text-xs font-bold shadow-inner">
      ...
      <section className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-14 z-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          
          {/* Card 1: Direct Hotline */}
          <div className="bg-white rounded-2xl p-6 shadow-xl shadow-slate-900/5 border border-slate-100 flex flex-col justify-between hover:border-emerald-500/50 hover:shadow-emerald-500/10 transition-all duration-300 group">
            <div className="space-y-3">
              <div className="w-12 h-12 rounded-2xl bg-emerald-50 text-emerald-600 flex items-center justify-center group-hover:scale-110 group-hover:bg-emerald-600 group-hover:text-white transition-all duration-300 shadow-sm">
              ...
              <div className="space-y-1">
                <a
                  href={\`tel:\${phone.replace(/\\s+/g, "")}\`}
                  className="block font-bold text-sm text-slate-900 hover:text-emerald-600 transition-colors"
                >
                  {phone}
                </a>
                {secondaryPhone && (
                  <a
                    ...
                    className="block font-medium text-xs text-slate-500 hover:text-emerald-600 transition-colors"
                  >
                    {secondaryPhone}
                  </a>
                )}
          ...
          <div className="bg-white rounded-2xl p-6 shadow-xl shadow-slate-900/5 border border-slate-100 flex flex-col justify-between hover:border-emerald-500/50 hover:shadow-emerald-500/10 transition-all duration-300 group">
            <div className="space-y-3">
              ...
              <div>
                ...
                <span className="block text-xs text-emerald-600 font-semibold mt-0.5">● Online & Ready</span>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-xl shadow-slate-900/5 border border-slate-100 flex flex-col justify-between hover:border-emerald-500/50 hover:shadow-emerald-500/10 transition-all duration-300 group">
            <div className="space-y-3">
              ...
              <div className="space-y-1">
                <a
                  href={\`mailto:\${email}\`}
                  className="block font-bold text-xs text-slate-900 hover:text-emerald-600 transition-colors truncate"
                  title={email}
                >
                  {email}
                </a>
                {secondaryEmail && (
                  <a
                    ...
                    className="block font-medium text-xs text-slate-500 hover:text-emerald-600 transition-colors truncate"
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-900 focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 font-medium transition-all"
                  />
                </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-900 focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 font-medium transition-all leading-relaxed"
                ></textarea>
              </div>
              ...
              <div className="flex items-center justify-between pt-2">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-7 py-3 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs shadow-lg shadow-emerald-600/30 transition-all hover:scale-105 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                >
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            {/* Urgent Help / Representative Box */}
            <div className="bg-gradient-to-br from-emerald-900 to-teal-900 text-white rounded-3xl p-6 shadow-xl shadow-emerald-900/10 border border-emerald-800/40 relative overflow-hidden flex flex-col sm:flex-row items-center gap-5">
              <div className="w-20 h-20 rounded-2xl bg-white/10 backdrop-blur-md overflow-hidden shrink-0 border border-white/20 relative flex items-center justify-center">
                {supportImage ? (
                  <img
                    src={supportImage}
              ...
              <div className="space-y-2 text-center sm:text-left flex-1">
                ...
                <p className="text-xs text-emerald-200 leading-relaxed">{supportDesc}</p>
                <a
                  href={\`tel:\${supportPhone.replace(/\\s+/g, "")}\`}
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-bold text-xs transition-all shadow-md mt-1"
                >
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
          ...
          {quickFaqs.map((faq, idx) => (
            ...
            >
              <button
                ...
                className="w-full px-6 py-4 text-left flex items-center justify-between gap-4 font-bold text-xs sm:text-sm text-slate-900 hover:text-emerald-600 transition-colors"
              >
                <span>{faq.q}</span>
                {openFaq === idx ? (
        ...
        <div className="mt-8 text-center">
          <Link
            href="/faq"
            className="inline-flex items-center gap-2 text-xs font-bold text-emerald-600 hover:text-emerald-700 bg-emerald-50 hover:bg-emerald-100 px-5 py-2.5 rounded-xl transition-all"
          >
...
const contactAliasPageCode = `"use client";
...
const contactUsDir = 'E:/xampp/htdocs/shopiabd-frontend/src/app/contact-us';
const contactDir = 'E:/xampp/htdocs/shopiabd-frontend/src/app/contact';
...
fs.writeFileSync(path.join(contactUsDir, 'page.tsx'), contactUsPageCode, 'utf8');
console.log('Successfully created E:/xampp/htdocs/shopiabd-frontend/src/app/contact-us/page.tsx');

fs.writeFileSync(path.join(contactDir, 'page.tsx'), contactAliasPageCode, 'utf8');
console.log('Successfully created E:/xampp/htdocs/shopiabd-frontend/src/app/contact/page.tsx');
