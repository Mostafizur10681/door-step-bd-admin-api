...
export default function ContactUsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      {/* 2. Hero Header Section with Primary Brand Color #0B3B82 */}
      <section className="relative overflow-hidden bg-gradient-to-b from-[#08234d] via-[#0B3B82] to-[#061836] text-white pt-16 pb-28 px-4 sm:px-6 lg:px-8">
        <div className="absolute inset-0 opacity-10 bg-[radial-gradient(#ffffff_1px,transparent_1px)] [background-size:20px_20px]"></div>
        <div className="absolute -top-24 -right-24 w-96 h-96 bg-[#1a56b0]/30 rounded-full blur-3xl pointer-events-none"></div>
        <div className="absolute -bottom-24 -left-24 w-96 h-96 bg-[#0B3B82]/40 rounded-full blur-3xl pointer-events-none"></div>

        <div className="relative max-w-4xl mx-auto text-center space-y-4">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-blue-100 text-xs font-bold shadow-inner">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            {/* Urgent Help / Representative Box with #0B3B82 */}
            <div className="bg-gradient-to-br from-[#08234d] via-[#0B3B82] to-[#061836] text-white rounded-3xl p-6 shadow-xl shadow-[#0B3B82]/20 border border-[#0B3B82]/40 relative overflow-hidden flex flex-col sm:flex-row items-center gap-5">
              ...
              <div className="space-y-2 text-center sm:text-left flex-1">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white hover:bg-blue-50 text-[#0B3B82] font-extrabold text-xs transition-all shadow-md mt-1 cursor-pointer"
                >
...
fs.writeFileSync('E:/xampp/htdocs/shopiabd-frontend/src/app/contact-us/page.tsx', updatedPageCode, 'utf8');
console.log('Updated E:/xampp/htdocs/shopiabd-frontend/src/app/contact-us/page.tsx with primary color #0B3B82');
