...
class AboutPageResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'experience_badge_text' => $this->experience_badge_text,
            'experience_badge_subtext' => $this->experience_badge_subtext,
            'story_points' => $this->story_points ?? [],
            'story_image' => $this->story_image ? (str_starts_with($this->story_image, 'data:') || str_starts_with($this->story_image, 'http') ? $this->story_image : url($this->story_image)) : null,
            ...
            'cta_phone' => $this->cta_phone,
            'cta_email' => $this->cta_email,
