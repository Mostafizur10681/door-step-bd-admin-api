...
Route::post('/coupons/validate', [\App\Http\Controllers\API\V1\CouponController::class, 'apply']);
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::middleware('role:admin')->prefix('admin')->group(function () {
        ...
        Route::post('/wishlists/{id}/notify', [AdminController::class, 'wishlistsNotify']);
